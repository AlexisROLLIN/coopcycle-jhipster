...
public class OrderResourceIT {
    ...
    private static final OrderState DEFAULT_ORDER_STATE = OrderState.PENDING;
    private static final OrderState UPDATED_ORDER_STATE = OrderState.CANCELLED;
    ...
    @Test
    @Transactional
    public void checkOrderStateIsRequired() throws Exception {
